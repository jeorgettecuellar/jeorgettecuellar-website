              ...
              >
                <div className="overflow-hidden">
                  <img
                    src={item.src}
                    alt={item.alt}
                    className="w-full className="w-full h-40 sm:h-44 md:h-48 lg:h-56 min-h-[160px] object-cover rounded lg"
 object-cover transform transition-transform duration-300 group-hover:scale-105"
                  />
                </div>
